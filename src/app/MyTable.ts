...
export function init(Survey: any) {
  var widget = {
    ...
    isFit: function (question) {
      ...
      return question.getType() === "mytable";
    ...
    activatedByChanged: function (activatedBy) {
      ...
      // }]
      Survey.JsonObject.metaData.addClass("mytable", [], null, "empty");
    ...
    htmlTemplate: "<my-table></my-table>",
    ...
    afterRender: function (question, el) {
      ...
      //el.mydata = JSON.stringify(question.mydata);
      console.log(text)
      //set some properties
